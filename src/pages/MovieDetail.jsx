...
const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=6d3a57ee2181db9aa9beb54da313a7bd`);
  ...
  return (
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 px-5 lg:px-0 text-lg dark:text-white">
